...
return [
    ...
    'console' => [
        ...
        'POST    orgs/<orgId:\d+>/orders/<orderId:\d+>/request-approval' => 'craftnet/orgs/orders/request-approval',
        'POST    orgs/<orgId:\d+>/orders/<orderId:\d+>/reject-request' => 'craftnet/orgs/orders/reject-request',
        'POST    orgs/<orgId:\d+>/orders/<orderId:\d+>/approve-request' => 'craftnet/orgs/orders/approve-request',
        'GET     orgs/<orgId:\d+>/members' => 'craftnet/orgs/members/get-members',
        'POST    orgs/<orgId:\d+>/members' => 'craftnet/orgs/members/add-member',
        'DELETE  orgs/<orgId:\d+>/members/<userId:\d+>' => 'craftnet/orgs/members/remove-member',
        'POST    orgs/<orgId:\d+>/members/<userId:\d+>/role' => 'craftnet/orgs/members/set-role',
