...
class PluginLicensesController extends BaseApiController
{
     ...
     */
    public function actionList($page = null, $perPage = null, bool $includeTrials = false): Response
    {
        ...
        $licenses = $this->module->getPluginLicenseManager()->getLicensesByDeveloper($user->id, $offset, $limit, $total, $includeTrials);
        return $this->asJson([
            'total' => $total,
