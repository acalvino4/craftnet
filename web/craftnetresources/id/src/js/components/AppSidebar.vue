  ...
  <div
    ...
    <ul>
      <li>
        <router-link
          @click.native="$emit('closeSidebar')"
          to="/licenses/cms">Craft CMS
        </router-link>
      </li>
      <li>
        <router-link
          @click.native="$emit('closeSidebar')"
          to="/licenses/plugins">Plugins
        </router-link>
      </li>
      <li>
        <router-link
          @click.native="$emit('closeSidebar')"
          to="/licenses/claim">Claim License
        </router-link>
      </li>
    </ul>
      ...
      <template v-if="userIsInGroup('developers')">
        ...
        <ul>
          <li>
            <router-link
              @click.native="$emit('closeSidebar')"
              to="/developer/plugins">Plugins
            </router-link>
          </li>
          <li>
            <router-link
              @click.native="$emit('closeSidebar')"
              to="/developer/sales">Sales
            </router-link>
          </li>
          <li>
            <router-link
              @click.native="$emit('closeSidebar')"
              to="/developer/profile">Profile
            </router-link>
          </li>
          <li>
            <router-link
              @click.native="$emit('closeSidebar')"
              to="/developer/settings">Settings
            </router-link>
          </li>
        </ul>
      </template>
      ...
      <template v-if="user.enablePartnerFeatures">
        ...
        <ul>
          <li>
            <router-link
              @click.native="$emit('closeSidebar')"
              to="/partner/overview">Overview
            </router-link>
          </li>
          <li>
            <router-link
              @click.native="$emit('closeSidebar')"
              to="/partner/profile">Profile
            </router-link>
          </li>
        </ul>
      </template>
    ...
    <ul>
      <li>
        <router-link
          @click.native="$emit('closeSidebar')"
          to="/account/developer-support">Developer Support
        </router-link>
      </li>
      <li>
        <router-link
