  ...
  <form
    ...
    <div class="card mt-6">
      <div class="card-body">
        ...
        <p class="text-secondary">Provide your PayPal email, which will be used
          for Plugin Store payouts in the event that there was a problem
          transferring via Stripe.</p>
        <textbox
          class="mt-4"
          id="paypalEmail"
