                ...
                <dd>
                  <template v-if="license.cmsLicense">
                    <p>
                      ...
                      <span
                        v-if="license.cmsLicense.edition"
                        class="text-secondary">(Craft {{
                    ...
                    <div class="buttons">
                      <btn
                        small
                        @click="detachCmsLicense()">Detach from this Craft
                        license
                      </btn>
    ...
    <div
      ...
      <div class="card-body">
        ...
        <div class="text-grey-dark">
          <p>Renewal Price:
            <strong>{{ license.edition.renewalPrice|currency }}/year</strong>.
          </p>

          <template v-if="licenseDraft.autoRenew">
            <p>Next payment:
              <strong>{{ license.expiresOn.date|moment('YYYY-MM-DD') }}</strong>.
            </p>
          </template>
        </div>
      </div>
    ...
    <div class="card mb-3">
      <div class="card-body">
        ...
        <template v-if="license.expirable && license.expiresOn">
          <btn @click="showRenewLicensesModal('plugin')">Renew your license…
          </btn>
        </template>
      </div>
    </div>
