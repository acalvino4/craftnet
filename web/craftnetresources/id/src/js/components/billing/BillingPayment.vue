      ...
      <div class="flex-1">
        ...
        <template v-else>
          <div v-if="!editing">
            ...
            <p
              v-else
              class="text-secondary">Add a credit card and use Craft ID to
              purchase licenses and renewals.</p>
          </div>
      ...
      <div
        ...
        <p>
          <template v-if="card">
            <btn
              small
              @click="editing = true">Change card
            </btn>
          </template>
          <template v-else>
            <btn
