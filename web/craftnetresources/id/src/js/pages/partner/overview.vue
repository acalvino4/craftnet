    ...
    <div class="card mb-4">
      <div class="card-body">
        <p>Welcome to Craft Partners. Here is where you will manage your
          <router-link to="profile">Partner profile</router-link>
          .
        </p>

        <p>We ask that you completely populate your profile with all
          ...
          information is current.</p>

        <p>Following the launch of Craft Partners, we will begin the
          Verification process. Once you've been verified we will
          add the corresponding verified badge to your profile.</p>

        <p>All Partners will receive the Craft Partner badge that you
        ...
        <p>If you have any questions, please contact us at
          <a href="mailto:partners@craftcms.com">partners@craftcms.com</a>.</p>
      </div>
    </div>
  </div>
</template>
