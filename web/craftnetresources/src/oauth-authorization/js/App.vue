<template>
    <div class="mt-16 container mx-auto max-w-md">
        <div class="px-8">
            <img class="max-w-none h-10" src="~@/common/images/craftcms.svg"/>
        </div>
        ...
        <form method="POST"
            ...
            <div class="space-y-4">
                ...
                <ul class="list-disc ml-6">
                    <template v-for="(scope, scopeKey) in oauthScopes"
                              :key="scopeKey">
                        <li>{{ scope }}</li>
                    </template>
                </ul>
            ...
            <div>
                <checkbox name="rememberMe" value="1"
            ...
            <div class="flex justify-between items-center">
                ...
                <div class="space-x-2">
                    <btn type="submit" name="deny" value="Deny">Cancel</btn>
                    <btn kind="primary" type="submit" name="approve"
