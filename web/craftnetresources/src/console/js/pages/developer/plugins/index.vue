<template>
    <div>
        ...
        <template v-else>
            <div v-if="computedPlugins.length > 0" class="overflow-x-auto">
                <table class="w-full">
                    <thead>
                    <tr>
                    ...
                    <tr v-for="(plugin, pluginKey) in computedPlugins"
                        :key="pluginKey" class="border-t">
                        <td class="py-4 px-2" style="min-width: 300px;">
                            <div class="flex items-start">
                                <div class="flex-shrink-0 mt-0.5">
                                    <router-link
                                        :to="'/developer/plugins/' + plugin.id">
                                        <img v-if="plugin.iconUrl"
                                             :src="plugin.iconUrl"
                                             class="w-10 h-10"/>
                                        <div v-else
                                             class="bg-gray-100 rounded-full p-2">
                                            <icon icon="plug" :size="null"
                                ...
                                <div class="ml-4">
                                    <router-link class="text-base font-medium"
                                                 :to="'/developer/plugins/' + plugin.id">
                                        {{ plugin.name }}
                                    </router-link>
