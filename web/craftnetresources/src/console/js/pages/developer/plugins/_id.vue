        ...
        <template v-else>
            ...
            <form @submit.prevent="save()">
                ...
                <pane class="mb-6">
                    ...
                    <template v-slot:default>
                        <field :first="true" label-for="name" label="Name"
                               :errors="errors.name">
                            <textbox id="name"
                        ...
                        <field label-for="packageName" label="Package Name"
                        ...
                        <field label-for="handle" label="Plugin Handle"
                        ...
                        <field label-for="licenseType" label="License">
                            <dropdown id="licenseType" :fullwidth="true"
                        ...
                        <field label-for="shortDescription"
                               label="Short Description"
                               :errors="errors.shortDescription">
                            <textbox id="shortDescription"
                                     v-model="pluginDraft.shortDescription"/>
                        </field>

                        <field label-for="longDescription"
                        ...
                        <field label-for="keywords" label="Keywords"
                        ...
                        <field label-for="abandoned" label="Abandoned plugin?">
                            <lightswitch
                                id="abandoned"
                ...
                <pane class="mb-6">
                    ...
                    <template v-slot:default>
                        ...
                        <div ref="screenshots" class="d-inline">
                            <draggable v-model="screenshots" item-key="id">
