    ...
    <div>
        <page-header>
            <div class="flex-1 text-center">
                ...
                <p class="mt-2"><a href="https://craftcms.com/support-services">Learn
                    more about Craft support options</a></p>
            </div>
        </page-header>
        ...
        <template v-if="!loading && subscriptionInfo">
            <div class="lg:flex mt-8 space-x-8">
            ...
            <div class="mt-8 text-center text-light">
                <p>Support plans cover emails to <a
                    href="mailto:support@craftcms.com">support@craftcms.com</a>
                    from <a :href="'mailto:'+user.email">{{ user.email }}</a>.
                </p>
                <p>Go to your
                    <router-link to="/settings/account">account settings
                    </router-link>
                    to change your email address.
                </p>
                <p>
                    <router-link to="/settings/developer-support">New version
                    </router-link>
                </p>
            </div>
        </template>
