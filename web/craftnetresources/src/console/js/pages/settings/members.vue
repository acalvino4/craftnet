<template>
    <div v-if="currentOrganization">
        <div class="flex items-center justify-between">
            ...
            <div>
                <btn kind="primary" @click="showInviteMembersModal = true">
                    Invite member
                </btn>
            </div>
        </div>
        ...
        <div class="mt-6 overflow-x-auto">
            <table class="w-full">
                ...
                <tbody>
                <tr v-for="(member, memberKey) in currentOrganization.members"
        ...
        <invite-members-modal :showInviteMembersModal="showInviteMembersModal"
