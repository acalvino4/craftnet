<template>
    <div class="mb-8">
            ...
            <div>
                <h1>
                    ...
                    <template v-if="partner">
                        <badge v-if="completionProfileIsLive"
                               class="ml-2 align-middle" type="success">Live
                        </badge>
                        <badge v-else class="ml-2 align-middle" type="default">
                            Pending
                        </badge>
                    </template>
                </h1>
        ...
        <div v-if="loadState == LOADED" class="space-y-6">
            <template v-if="!completionProfileIsLive">
                <partner-completion :partner="partner"
