        ...
        <template v-else>
            <template v-if="license">
                <page-header>
                    <div>
                        <p>
                            <router-link class="nav-link" to="/licenses/cms"
                                         exact>← Craft CMS
                            </router-link>
                        </p>
                    ...
                    <pane class="border border-red-500 mb-3">
                        ...
                        <div class="lg:flex lg:justify-between lg:items-center">
                            ...
                            <div class="mt-6 lg:mt-0">
                                <btn kind="danger" @click="releaseCmsLicense()">
                                    Release License
                                </btn>
                            </div>
                        </div>
                        ...
                        <div class="lg:flex lg:justify-between lg:items-center">
                            ...
                            <div class="mt-6 lg:mt-0">
                                <btn kind="danger" @click="showTransferCmsLicenseModal = true">
                                    Transfer license
                                </btn>

                                <transfer-license-modal type="cms" :license="license" :isOpen="showTransferCmsLicenseModal" @close="showTransferCmsLicenseModal = false"></transfer-license-modal>
                            </div>
                        </div>
                    </pane>
                </div>
