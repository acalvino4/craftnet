          ...
          <pane class="border border-red-500 mb-3">
            ...
            <div class="lg:flex lg:justify-between lg:items-center">
              ...
              <div class="mt-6 lg:mt-0">
                <btn
                  kind="danger"
                  @click="showTransferPluginLicenseModal = true">
                  Transfer license
                </btn>
                ...
                <transfer-license-modal
                  type="plugin"
                  :license="license"
                  :isOpen="showTransferPluginLicenseModal"
                  @close="showTransferPluginLicenseModal = false"></transfer-license-modal>
              </div>
            </div>
          </pane>
        </div>
