<template>
    <modal-headless :isOpen="showInviteMembersModal" @close="$emit('close')">
        ...
        <div class="mt-4">
            ...
            <div class="mt-2 space-y-2">
                <div class="border-t py-2 flex items-start">
                    <div class="w-36">
                        <radio v-model="role" value="owner" class="mr-4" label="Owner"></radio>
                    </div>
                ...
                <div class="border-t py-2 flex items-start">
                    <div class="w-36">
                        <radio v-model="role" value="member" class="mr-4" label="Member"></radio>
                    </div>
                    <ul class="text-sm py-2">
