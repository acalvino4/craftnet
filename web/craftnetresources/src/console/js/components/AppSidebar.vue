<template>
    <div
        ...
        <ul>
            <li>
                <router-link @click="$emit('closeSidebar')" to="/licenses/cms">
                    <icon class="mr-2 text-blue-500 w-5 h-5" icon="key"/>
                    Craft CMS
                </router-link>
            </li>
            <li>
                <router-link @click="$emit('closeSidebar')"
                             to="/licenses/plugins">
                    <icon class="mr-2 text-blue-500 w-5 h-5" icon="key"/>
                    Plugins
                </router-link>
            ...
            <template v-if="userIsInGroup('developers')">
                ...
                <ul>
                    <li>
                        <router-link @click="$emit('closeSidebar')"
                                     to="/developer/sales">
                            <icon class="mr-2 text-blue-500 w-5 h-5"
        ...
        <ul>
            <template v-if="!currentOrganization && user">
                <li>
                    <router-link @click="$emit('closeSidebar')"
                                 to="/settings/account">
                        <icon class="mr-2 text-blue-500 w-5 h-5" icon="cog"/>
                        Account
                    </router-link>
                </li>
            </template>
            ...
            <li v-if="currentOrganization">
                <router-link @click="$emit('closeSidebar')"
                             to="/settings/members">
                    <icon class="mr-2 text-blue-500 w-5 h-5" icon="user-group"/>
                    Members
                </router-link>
            </li>
            <li>
            ...
            <li v-if="!currentOrganization">
                <router-link @click="$emit('closeSidebar')"
                    ...
                    <icon class="mr-2 text-blue-500 w-5 h-5" icon="collection"/>
                    Organizations
                </router-link>
            </li>
            ...
            <li>
                <router-link @click="$emit('closeSidebar')"
                    ...
                    <icon class="mr-2 text-blue-500 w-5 h-5" icon="support"/>
                    Developer Support
                </router-link>
            </li>
