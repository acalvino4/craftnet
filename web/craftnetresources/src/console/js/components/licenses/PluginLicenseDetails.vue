  ...
  <div class="space-y-6">
            ...
            <dl>
              ...
              <dd>
                ...
                <div class="space-x-3">
                  ...
                  <a @click="revealLicenseKey = !revealLicenseKey">{{
                      revealLicenseKey ? 'Hide' : 'Reveal'
                    }}</a>
                </div>
              </dd>
    ...
    <pane v-if="license.expirable && license.expiresOn">
      ...
      <div class="text-grey-dark">
        <p>Renewal Price:
          <strong>{{
              $filters.currency(license.edition.renewalPrice)
            }}/year</strong>.
        </p>
    ...
    <pane>
      ...
      <template v-if="license.expirable && license.expiresOn">
        <btn @click="showRenewPluginLicenseModal = true">Renew your license
        </btn>
