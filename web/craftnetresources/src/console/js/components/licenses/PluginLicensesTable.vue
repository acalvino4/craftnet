<template>
    <div class="responsive-content">
        <table class="table">
            ...
            <tbody>
            <template v-for="(license, licenseIndex) in licenses"
                      :key="licenseIndex">
                <tr>
                    <td>
                        <code>
                            <router-link v-if="license.key"
                    ...
                    <td v-if="!excludeCmsLicenseColumn">
                        <template v-if="license.cmsLicense">
                            <code>
                                <router-link v-if="license.cmsLicense.key"
                    ...
                    <td>
                        <template v-if="autoRenewSwitch">
                            <template v-if="!!license.key && license.expiresOn">
                                <lightswitch
                                    ...
                                    @input="savePluginLicenseAutoRenew(license, $event)"
                                    v-model:checked="pluginLicensesAutoRenew[license.id]"
                        ...
                        <template v-else>
                            <badge v-if="license.autoRenew == 1" type="success">
                                Enabled
                            </badge>
