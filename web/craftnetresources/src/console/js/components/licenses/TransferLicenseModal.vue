<template>
    <modal-headless :isOpen="isOpen"
        ...
        <template v-if="type === 'cms' && license.pluginLicenses.length > 0">
            ...
            <h4 class="mt-4 font-medium leading-6">Do you want to transfer plugin licenses as well?</h4>
            <div class="mt-2 border-t border-b py-2">
                <template v-for="(pluginLicense, pKey) in license.pluginLicenses" :key="pKey">
        ...
        <field :vertical="true" label-for="new-username"
            ...
            <textbox id="new-username" v-model="newUsername"></textbox>
        </field>
