<template>
    <div>
        <field label-for="first-name" label="First Name">
            <textbox placeholder="First Name" id="first-name"
                     v-model="computedBillingInfo.firstName"
                     :errors="errors['billingAddress.firstName']"/>
        </field>
        <field label-for="last-name" label="Last Name">
            <textbox placeholder="Last Name" id="last-name"
                     v-model="computedBillingInfo.lastName"
                     :errors="errors['billingAddress.lastName']"/>
        </field>
        <field label-for="business-name" label="Business Name">
            <textbox placeholder="Business Name" id="business-name"
                     v-model="computedBillingInfo.businessName"
                     :errors="errors['billingAddress.businessName']"/>
        </field>
        <field label-for="business-tax-id" label="Business Tax ID">
            <textbox placeholder="Business Tax ID" id="business-tax-id"
                     v-model="computedBillingInfo.businessTaxId"
                     :errors="errors['billingAddress.businessTaxId']"/>
        </field>
        <field label-for="address-1" label="Address 1">
            <textbox placeholder="Address 1" id="address-1"
                     v-model="computedBillingInfo.address1"
                     :errors="errors['billingAddress.address1']"/>
        </field>
        <field label-for="address-2" label="Address 2">
            <textbox placeholder="Address 2" id="address-2"
                     v-model="computedBillingInfo.address2"
                     :errors="errors['billingAddress.address2']"/>
        </field>

        <field label-for="city" label="City">
            <textbox placeholder="City" id="city"
                     v-model="computedBillingInfo.city"
                     :errors="errors['billingAddress.city']"/>
        </field>
        <field label-for="zip-code" label="Zip Code">
            <textbox placeholder="Zip Code" id="zip-code"
        ...
        <field label-for="country" label="Country">
            ...
            <template v-else>
                <dropdown :fullwidth="true" :options="countryOptions"
                          v-model="computedBillingInfo.country" id="country"
        ...
        <field label-for="state" label="State">
            <template v-if="!loading">
                <dropdown :fullwidth="true"
                          ...
                          v-model="computedBillingInfo.state" id="state"
